            ...
            <div class="col-12">
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title">Modificar datos de la orden actual</h3>
                </div>
                <!-- /.card-header -->
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="numbers-row">
                                      @foreach (session('quantity') as $quantity)
                                          @if ($quantity->get('id') == $product->id)
                                            <input type="text" value="{{$quantity->get('quantity')}}" id="quantity" class="qty2" name="quantity">
                                          @endif
                                      @endforeach
